/*!
 * vuetify-daterange-picker v2.6.2
...
var DateRange = { render: function () {
  ...
  computed: {
    formattedStartDate: function formattedStartDate() {
      return this.startDate ? format(parse(this.startDate), this.format) : '';
    },
  ...
  methods: {
    ...
    setInRangeData: function setInRangeData() {
      ...
      if (this.highlightRange) {
        var startDate = parse(this.startDate);
        var endDate = parse(this.endDate);
